...
--Timers
Config.timer = 160 -- countdown to secure lock in seconds (time needed to pass to door to be closed back)
Config.cooldown = 7200 -- amount of time to do the heist again in seconds (15min)

--Cop Settings
Config.UsePSDispatch = false
...
Config.needSecurityCard = true -- If Security card is false then you will need the security cards if false then you just need to hack
Config.needToHack = true
Config.SecurityCardDoor1 = 'security_card_01'
Config.SecurityCardDoor2 = 'security_card_01'
Config.hackingDevice = 'laptop'

--Mz Skills
Config.useMzSkills = false
Config.skillName = "Street Reputation"
Config.minSkillLevel = 0
Config.minSkillRewardLevel = 10 --per door
Config.maxSkillRewardLevel = 20 --per door

--Rewards
Config.black = false -- enable this if you want blackmoney as a reward
Config.itemRewardBool = true 
Config.itemChance = 100 -- Percentage item chance
...
Config.Banks = {
    F1 = {
        doors = {
            startloc = {x = 311.22, y = -284.34, z = 54.16, h = 160.32, animcoords = vector4(311.1, -284.29, 54.16, 162.26)},
            secondloc = {x = 312.92, y = -284.75, z = 54.16, h = 161.67, animcoords = vector4(312.92, -284.75, 54.16, 161.67)},
        },
        prop = {
    ...
    F2 = {
        doors = {
            startloc = {x = 146.84, y = -1045.99, z = 29.37, h = 158.1, animcoords = vector4(146.68, -1045.84, 29.37, 158.1)},
            secondloc = {x = 148.57, y = -1046.36, z = 29.37, h = 161.76, animcoords = vector4(148.57, -1046.36, 29.37, 161.76)}
        },
        prop = {
