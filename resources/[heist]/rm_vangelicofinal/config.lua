...
Config['VangelicoHeist'] = {
    ...
    ['keycardChance'] = 60, -- Vangelico keycard spawn chance for secret room
    ...
    ['smashRewards'] = { -- You can add new reward items for all grab actions. (smash, grab, trolly) Don't change the diamond item order.
        {item = 'diamond',   count = function() return math.random(5, 20) end, sellPrice = 400},
        {item = 'goldwatch', count = function() return math.random(5, 20) end, sellPrice = 400},
        {item = 'ring',      count = function() return math.random(5, 20) end, sellPrice = 400},
        {item = 'necklace',  count = function() return math.random(5, 20) end, sellPrice = 400},
    },
